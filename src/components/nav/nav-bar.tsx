    ...
    <header className="glass-bar sticky top-0 z-30 border-b border-border/60 pt-[env(safe-area-inset-top)]">
      <div className="mx-auto grid h-11 max-w-xl grid-cols-[1fr_auto_1fr] items-center px-1">
        <button
          ...
          className="-ml-2 flex h-11 items-center gap-0.5 justify-self-start rounded-md pl-2 pr-3 text-primary-ink transition-opacity outline-none focus-visible:ring-2 focus-visible:ring-ring active:opacity-60"
        >
